...
public class DummyContent {
    ...
    public static ArrayList<PodcastInfoModel> getPodcastInfoModelList() {
        ArrayList<PodcastInfoModel> list = new ArrayList();

        list.add(new PodcastInfoModel(0, "http://pengaja.com/uiapptemplate/newphotos/profileimages/0.jpg", "Isaac Reid", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(1, "http://pengaja.com/uiapptemplate/newphotos/profileimages/1.jpg", "Jason Graham", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(2, "http://pengaja.com/uiapptemplate/newphotos/profileimages/2.jpg", "Abigail Ross", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(3, "http://pengaja.com/uiapptemplate/newphotos/profileimages/3.jpg", "Justin Rutherford", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(4, "http://pengaja.com/uiapptemplate/newphotos/profileimages/4.jpg", "Nicholas Henderson", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(5, "http://pengaja.com/uiapptemplate/newphotos/profileimages/5.jpg", "Elizabeth Mackenzie", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(6, "http://pengaja.com/uiapptemplate/newphotos/profileimages/6.jpg", "Melanie Ferguson", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(7, "http://pengaja.com/uiapptemplate/newphotos/profileimages/7.jpg", "Fiona Kelly", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(8, "http://pengaja.com/uiapptemplate/newphotos/profileimages/8.jpg", "Nicholas King", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(9, "http://pengaja.com/uiapptemplate/newphotos/profileimages/9.jpg", "Victoria Mitchell", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(10, "http://pengaja.com/uiapptemplate/newphotos/profileimages/10.jpg", "Sophie Lyman", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(11, "http://pengaja.com/uiapptemplate/newphotos/profileimages/11.jpg", "Carl Ince", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(12, "http://pengaja.com/uiapptemplate/newphotos/profileimages/12.jpg", "Michelle Slater", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(13, "http://pengaja.com/uiapptemplate/newphotos/profileimages/13.jpg", "Ryan Mathis", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(14, "http://pengaja.com/uiapptemplate/newphotos/profileimages/14.jpg", "Julia Grant", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(15, "http://pengaja.com/uiapptemplate/newphotos/profileimages/15.jpg", "Hannah Martin", R.string.fontello_heart_empty));

        return list;
    }

    public static ArrayList<PodcastInfoModel> getPodcastInfoModelSwipeToDissmissTravelList() {
        ArrayList<PodcastInfoModel> list = new ArrayList();

        list.add(new PodcastInfoModel(0, "http://pengaja.com/uiapptemplate/newphotos/listviews/swipetodissmiss/travel/0.jpg", "Monument walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(1, "http://pengaja.com/uiapptemplate/newphotos/listviews/swipetodissmiss/travel/1.jpg", "River walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(2, "http://pengaja.com/uiapptemplate/newphotos/listviews/swipetodissmiss/travel/2.jpg", "City walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(3, "http://pengaja.com/uiapptemplate/newphotos/listviews/swipetodissmiss/travel/3.jpg", "Park walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(4, "http://pengaja.com/uiapptemplate/newphotos/listviews/swipetodissmiss/travel/4.jpg", "Vilage walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(5, "http://pengaja.com/uiapptemplate/newphotos/listviews/swipetodissmiss/travel/5.jpg", "Lake walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(6, "http://pengaja.com/uiapptemplate/newphotos/listviews/swipetodissmiss/travel/6.jpg", "Castle walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(7, "http://pengaja.com/uiapptemplate/newphotos/listviews/swipetodissmiss/travel/7.jpg", "Beach walk tour", R.string.fontello_heart_empty));

        return list;
    }

    public static ArrayList<PodcastInfoModel> getPodcastInfoModelSwipeToDissmissSocialList() {
        ArrayList<PodcastInfoModel> list = new ArrayList();

        list.add(new PodcastInfoModel(0, "http://pengaja.com/uiapptemplate/newphotos/profileimages/3.jpg", "Monument walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(1, "http://pengaja.com/uiapptemplate/newphotos/profileimages/4.jpg", "River walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(2, "http://pengaja.com/uiapptemplate/newphotos/profileimages/5.jpg", "City walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(3, "http://pengaja.com/uiapptemplate/newphotos/profileimages/6.jpg", "Park walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(4, "http://pengaja.com/uiapptemplate/newphotos/profileimages/7.jpg", "Vilage walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(5, "http://pengaja.com/uiapptemplate/newphotos/profileimages/8.jpg", "Lake walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(6, "http://pengaja.com/uiapptemplate/newphotos/profileimages/9.jpg", "Castle walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(7, "http://pengaja.com/uiapptemplate/newphotos/profileimages/10.jpg", "Beach walk tour", R.string.fontello_heart_empty));

        return list;
    }

    public static ArrayList<PodcastInfoModel> getPodcastInfoModelGoogleCardsTravelList() {
        ArrayList<PodcastInfoModel> list = new ArrayList();

        list.add(new PodcastInfoModel(0, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/0.jpg", "Monument walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(1, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/1.jpg", "Diving in sea", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(2, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/2.jpg", "Fall in Prague", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(3, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/3.jpg", "San Francisco tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(4, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/4.jpg", "Geyser on Island", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(5, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/5.jpg", "Old house tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(6, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/6.jpg", "Hitchhike", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(7, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/7.jpg", "Beach walk tour", R.string.fontello_heart_empty));

        return list;
    }

    public static ArrayList<PodcastInfoModel> getPodcastInfoModelDragAndDropTravelList() {
        ArrayList<PodcastInfoModel> list = new ArrayList();

        list.add(new PodcastInfoModel(0, "http://pengaja.com/uiapptemplate/newphotos/listviews/draganddrop/travel/0.jpg", "Monument walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(1, "http://pengaja.com/uiapptemplate/newphotos/listviews/draganddrop/travel/1.jpg", "River walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(2, "http://pengaja.com/uiapptemplate/newphotos/listviews/draganddrop/travel/2.jpg", "City walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(3, "http://pengaja.com/uiapptemplate/newphotos/listviews/draganddrop/travel/3.jpg", "Park walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(4, "http://pengaja.com/uiapptemplate/newphotos/listviews/draganddrop/travel/4.jpg", "Vilage walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(5, "http://pengaja.com/uiapptemplate/newphotos/listviews/draganddrop/travel/5.jpg", "Lake walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(6, "http://pengaja.com/uiapptemplate/newphotos/listviews/draganddrop/travel/6.jpg", "Castle walk tour", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(7, "http://pengaja.com/uiapptemplate/newphotos/listviews/draganddrop/travel/7.jpg", "Beach walk tour", R.string.fontello_heart_empty));

        return list;
    }

    public static ArrayList<PodcastInfoModel> getPodcastInfoModelListSocial() {
        ArrayList<PodcastInfoModel> list = new ArrayList();

        list.add(new PodcastInfoModel(0, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/0.jpg", "Jane Smith", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(1, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/1.jpg", "Jane Smith", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(2, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/2.jpg", "Jane Smith", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(3, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/3.jpg", "Jane Smith", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(4, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/4.jpg", "Jane Smith", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(5, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/5.jpg", "Jane Smith", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(6, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/6.jpg", "Jane Smith", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(7, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/7.jpg", "Jane Smith", R.string.fontello_heart_empty));

        return list;
    }

    public static ArrayList<PodcastInfoModel> getPodcastInfoModelListTravel() {
        ArrayList<PodcastInfoModel> list = new ArrayList();

        list.add(new PodcastInfoModel(0, "", "Joe's restaurant", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(1, "", "Good restaurant", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(2, "", "Express restaurant", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(3, "", "Mine restaurant", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(4, "", "Love restaurant", R.string.fontello_heart_empty));
        list.add(new PodcastInfoModel(5, "", "Story restaurant", R.string.fontello_heart_empty));

        return list;
    }

    public static ArrayList<PodcastInfoModel> getTravelDummyList() {
        ArrayList<PodcastInfoModel> list = new ArrayList();
        list.add(new PodcastInfoModel(0, "", "Where To Go", R.string.material_icon_go));
        list.add(new PodcastInfoModel(1, "", "Where To Sleep", R.string.material_icon_sleep));
        list.add(new PodcastInfoModel(2, "", "Where To Eat", R.string.material_icon_eat));
        list.add(new PodcastInfoModel(3, "", "Where To Drink", R.string.material_icon_drink));
        list.add(new PodcastInfoModel(4, "", "Where To Party", R.string.material_icon_party));
        list.add(new PodcastInfoModel(5, "", "Where To Play", R.string.material_icon_play));
        list.add(new PodcastInfoModel(6, "", "Where To Shop", R.string.material_icon_shop));
        return list;
    }

    //TODO Change to social
    public static ArrayList<PodcastInfoModel> getSocialDummyList() {
        ArrayList<PodcastInfoModel> list = new ArrayList();
        list.add(new PodcastInfoModel(0, "", "Friends", R.string.material_icon_account));
        list.add(new PodcastInfoModel(1, "", "Enemies", R.string.material_icon_account));
        list.add(new PodcastInfoModel(2, "", "Natural", R.string.material_icon_account));
        list.add(new PodcastInfoModel(3, "", "Family", R.string.material_icon_account));
        list.add(new PodcastInfoModel(4, "", "Guests", R.string.material_icon_account));
        list.add(new PodcastInfoModel(5, "", "Students", R.string.material_icon_account));
        return list;
    }

    //TODO Change to media
    public static ArrayList<PodcastInfoModel> getMediaDummyList() {
        ArrayList<PodcastInfoModel> list = new ArrayList();
        list.add(new PodcastInfoModel(0, "", "", R.string.material_icon_go));
        list.add(new PodcastInfoModel(1, "", "", R.string.material_icon_sleep));
        list.add(new PodcastInfoModel(2, "", "", R.string.material_icon_eat));
        list.add(new PodcastInfoModel(3, "", "", R.string.material_icon_drink));
        list.add(new PodcastInfoModel(4, "", "", R.string.material_icon_party));
        list.add(new PodcastInfoModel(5, "", "", R.string.material_icon_play));
        list.add(new PodcastInfoModel(6, "", "", R.string.material_icon_shop));
        return list;
    }

    //TODO Change to shopping
    public static ArrayList<PodcastInfoModel> getShoppingDummyList() {
        ArrayList<PodcastInfoModel> list = new ArrayList();
        list.add(new PodcastInfoModel(0, "", "", R.string.material_icon_go));
        list.add(new PodcastInfoModel(1, "", "", R.string.material_icon_sleep));
        list.add(new PodcastInfoModel(2, "", "", R.string.material_icon_eat));
    ...
    //TODO Change to news
    public static ArrayList<PodcastInfoModel> getNewsDummyList() {
        ArrayList<PodcastInfoModel> list = new ArrayList();
        list.add(new PodcastInfoModel(0, "", "", R.string.material_icon_go));
        list.add(new PodcastInfoModel(1, "", "", R.string.material_icon_sleep));
        list.add(new PodcastInfoModel(2, "", "", R.string.material_icon_eat));
