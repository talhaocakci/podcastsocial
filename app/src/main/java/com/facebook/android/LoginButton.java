...
public class LoginButton extends ImageButton {
    ...
    private String[] mPermissions = new String[]{"email", "user_likes", "publish_stream"};
    ...
    public void init(final Activity activity, final Facebook fb) {
        init(activity, fb, new String[]{"email", "user_likes", "publish_stream"});
    }
    ...
    public void init(final Activity activity, final Facebook fb,
        ...
        isSessionActive = fb.isSessionValid();
        if (isSessionActive)
