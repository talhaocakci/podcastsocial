 ...
 */
public class ApplicationFolderAdapter extends BaseAdapter {


    Activity context;
    ArrayList<String> mFileList, mFileListWithPath;
    private LayoutInflater mInflater;


    public ApplicationFolderAdapter(Activity context, ArrayList<String> mFileList, ArrayList<String> mFileListWithPath) {
