...
package com.javathlon.inapp_purchase;
...
public class IabHelper {
    ...
    public Double getPricesDev(String packageName, String skuName) throws RemoteException, JSONException {
        ...
        if (response == 0) {
            ...
            for (String thisResponse : responseList) {
                ...
                if (details.getSku().contains(skuName))
                    return Double.valueOf(details.getPrice().replaceAll("[^\\d.]", ""));
