...
//            }
    ...
    public void WriteFile(File outputFile, int startFrame, int numFrames)
        ...
        for (int i = 0; i < numFrames; i++) {
            ...
            pos += len;
            if (i == numFrames - 1) {
                Tag t = this.readTagRandomAccessFile(mInputFile);
                Log.e("Album: ", "" + t.getAlbum());
                Log.e("Artist: ", "" + t.getArtist());
                Log.e("Comment: ", "" + t.getComment());
                Log.e("Title: ", "" + t.getTitle());
                Log.e("Year: ", "" + t.getYear());
                if (buf != null) {
                    if (buf.length > 0) {
                        out.write(buf);
                    }
    ...
    public Tag readTagRandomAccessFile(File file) throws IOException {
